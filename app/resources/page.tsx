    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-20 px-4 sm:px-6 lg:px-8 overflow-hidden min-h-[70vh] flex items-center">
        ...
        <div className="absolute inset-0">
          <Image
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/20250930_0005_House%20and%20CN%20Tower_remix_01k6cckn8reznv5scbm75bqyg7-VFHoTAC5eNyJSNxYwZknxLRal63udJ.png"
            alt="Best Mortgage Loans Billboard with CN Tower"
            fill
